  ...
  return (
    <nav className="w-full flex justify-center mt-8 gap-2 mb-8 ">
      <Link
        ...
        className={`${
          activeBtn === "profile" ? activeBtnStyles : notActiveBtnStyles
        }`}
      >
        <svg
      ...
      <Link
        to={"/account/bookings"}
        onClick={() => {
          setActiveBtn("bookings");
        }}
        className={`${
          activeBtn === "bookings" ? activeBtnStyles : notActiveBtnStyles
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      <Link
        ...
        className={`${
          activeBtn === "places" ? activeBtnStyles : notActiveBtnStyles
        }`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
